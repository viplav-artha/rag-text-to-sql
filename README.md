...
Required for every request — this is the LLM. Make sure your SSO session is active:
...
The API is now available at `http://localhost:8010` (Swagger docs at `/docs`). One endpoint, taking just `{"question": "..."}`:
